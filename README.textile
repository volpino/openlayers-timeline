...
I know that there are other timelines for OpenLayers like "maptimeline":http://code.google.com/p/maptimeline/
or "timemap":http://code.google.com/p/timemap/ but none of these was what i needed for "WikiTrip":http://sonetlab.fbk.eu/wikitrip/
They are both based on Simile Timeline, which is really cool, but they don't support cluster strategy
and they are extremely slow with huge amount of data (>1000 points).
